...
I design and ship end-to-end systems across frontend, backend, and AWS infrastructure — from
in-house video conferencing and real-time analytics to multi-tenant platforms serving 1000+ users.
...
| :------ | :---------- | :---- |
| **🎓 [Turtled](https://withturtled.com/)** | Automated EdTech platform serving K–12 students in the U.S. — tutor onboarding, live classes, and an in-house video conferencing suite with an interactive whiteboard. | `React` `NestJS` `WebSockets` `AWS` |
| **🤝 [CJoin](https://cjoin.io/)** | Creator & business marketplace for marketing campaigns — secure payments, performance-based payouts, and automated multi-platform metric pipelines. | `React Native` `Node.js` `Stripe` |
| **🏥 [Clinisys.ai](https://clinisys.ai)** | AI-powered financial platform for hospitals & labs — revenue tracking, compliance reporting, and AI-driven insights in a multi-tenant setup. | `React` `NestJS` `Pinecone` |
